...
const NAV_LINKS = [
    { label: "Browse Jobs", href: "/candidate/browse" },
    { label: "Saved",       href: "/candidate/saved" },
];

const DASHBOARD_LINKS = [
    { icon: "🏠", label: "My Dashboard", href: "/candidate/dashboard" },
    { icon: "📄", label: "My Resume",    href: "/candidate/dashboard?section=resume" },
    { icon: "📬", label: "Applications", href: "/candidate/applications" },
    { icon: "🔔", label: "Notifications",href: "/candidate/notifications" },
    { icon: "⚙️", label: "Settings",     href: "/candidate/setting" },
];
...
const confirmApply = async () => {
    ...
    // ─────────────────────────────────────────────
    return (
       <div className="candidate-home" style={{ fontFamily: "'DM Sans', sans-serif", background: "var(--bg-primary)", minHeight: "100vh", color: "#111827" }}>

            <style>{`
        @import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600&family=Sora:wght@600;700&display=swap');
        .candidate-home * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      `}</style>
            ...
            <nav style={{
                ...
                <span style={{ fontFamily: "'Sora',sans-serif", fontWeight: 700, fontSize: 18, letterSpacing: "-0.5px", color: "#111827" }}>Candidate</span>
                    {/* <span style={{ fontSize: 10, background: "#EEF2FF", color: "#1C3FA8", padding: "2px 8px", borderRadius: 20, fontWeight: 600, border: "1px solid #C7D2F8" }}>Candidate</span> */}
                </div>
            ...
            <section style={{ padding: "60px 32px 40px", textAlign: "center", background: "linear-gradient(160deg,#fff 60%,#F3F5FF 100%)", borderBottom: "1px solid #E5E7EB", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                    ...
                    <p style={{ fontSize: 14, color: "#6B7280", maxWidth: 400, margin: "0 auto 28px", lineHeight: 1.65 }}>
                        Browse roles from {stats.companies > 0 ? `${stats.companies}+` : "hundreds of"} companies. Apply in one click with your candidate profile.
                    </p>
            ...
            {/* ══ JOB DECK BANNER ══ */}
            <JobDeckBanner onEnter={() => navigate("/candidate/swipe")} />
...
//     getSavedJobIds,
// } from "../../services/candidate.service";
// import { getProfile } from "../../services/candidate.service";
// import type { CandidateProfile } from "../../types/candidate.types";
...
//     { icon: "📬", label: "Applications", href: "/candidate/applications" },
//     { icon: "🔔", label: "Notifications", href: "/candidate/notifications" },
//     { icon: "⚙️", label: "Settings", href: "/candidate/settings" },
// ];
