...
import type { CandidateProfile, SocialProfile } from '../../types/candidate.types';
...
function deriveName(profile: CandidateProfile): { first: string; last: string; full: string } {
...
function resolveLocation(profile: CandidateProfile): string {
