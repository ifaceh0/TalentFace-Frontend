...
export default function AdminDashboard() {
  ...
  const STATS = [
    ...
    { label: "Candidates", value: stats?.totalCandidates ?? 0, delta: 0, accent: "#E53E3E", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg> },
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex rounded-xl overflow-hidden border border-gray-200">
                  {(["all", "recruiter", "candidate"] as const).map((r) => (
                    <button
                      key={r}
                      ...
                      style={{
                        background: roleFilter === r
                          ? r === "recruiter" ? "#1D4ED8" : r === "candidate" ? "#E53E3E" : "#111"
                          : "transparent",
